...
"INSERT INTO faaliyetler (baslik, yas_grubu, aciklama)
VALUES ('$baslik','$yas_grubu','$aciklama')");
    if ($ekle) {
        $basari = "Faaliyet alanı başarıyla eklendi.";
    } else {
        $hata = "Faaliyet eklenirken hata oluştu.";
    }
}
?>
...
<main class="content">
    ...
    <div class="top-area">
        ...
        <div>
            <h1>Faaliyet Alanı Ekle</h1>

            <p>
                Ana sayfada görüntülenecek faaliyet alanlarını buradan oluşturabilirsin.
            </p>
        </div>
...
<div class="mb-4">
    ...
    <select name="yas_grubu" class="form-control" required>
        ...
        <option value="4-6 yaş">
            4-6 yaş
        </option>

        <option value="7-9 yaş">
            7-9 yaş
        </option>

        <option value="10-12 yaş">
            10-12 yaş
        </option>

        <option value="13-15 yaş">
            13-15 yaş
        </option>

        <option value="Tüm yaş grupları">
            Tüm yaş grupları
        </option>
            ...
            <div class="mb-4">
                ...
                <input type="text"
                       name="baslik"
                       class="form-control"
                       placeholder="Örn: Çocuk Tiyatrosu ve Drama"
                       required>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="aciklama"
                          class="form-control"
                          placeholder="Faaliyet alanını detaylı şekilde açıklayın..."
                          required></textarea>
            </div>
